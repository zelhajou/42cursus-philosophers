...
/*   Updated: 2024/01/26 12:00:12 by zelhajou         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_philo *initialize_philosophers(t_philo *philosophers)
{
	...
	philosophers_initialized = malloc(sizeof(t_philo) * philosophers->num_philosophers);
	...
	initialize_philosopher_data(philosophers_initialized, philosophers, forks, last_meal_time);
